        ...
        <div className="hero bg-base-200 my-10 p-10">
            <div className="hero-content flex-col lg:flex-row gap-10">
                ...
                <div className='w-1/2 space-y-5'>
                   ...
                   <p className='text-[#737373] text-md'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable. </p>
